...
if __name__ == '__main__':
    ...
    _output = 'hdfs://master:8020/impala/parquet/back/back-portal-loginflowlog/dat=%s' % today
    ...
    sql = "(select concat('portal') as dfrom,log_type as logtype,convert(hos_id,char) as hosid,convert(supp_id,char) as suppid,gw_id as gwid," \
          "user_mac as usermac,login_version as loginversion,forward_version as forwardversion,arrive_version as arriveversion,login_type as logintype," \
          "is_new_user as isnewuser,log_time as logtime from log_login_flow " \
